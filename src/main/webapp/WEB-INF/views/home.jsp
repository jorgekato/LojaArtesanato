...
<tags:pageTemplate titulo="Livros de Java, Android, iOS e muito mais">
	<section id="index-section" class="container middle">
		...
		<c:if test="${empty message }">
			<h1 class="cdc-call"><fmt:message key="body.home.sales"/></h1>
		</c:if>
        ...
        <ul class="clearfix book-collection">
            ...
            <li>
                <a href="${s:mvcUrl('PC#detalhe').arg(0, produto.id).build()}" class="block clearfix">
                    ...
                    <small class="buy-button"><fmt:message key="body.home.buy" /></small>
                </a>
            </li>
            </c:forEach>
        </ul>

        <h2 class="cdc-call"><fmt:message key="body.home.differentials"/></h2>
